...
nick = raw_input("Nick : ")
team = raw_input("Team : ")
gmbr = raw_input("Gambar [URL] : ")
thx = raw_input("Thanks : ")

fo = open("script.html","w")

sbi1 = """<!DOCTYPE html><html><link rel="icon" type="image/gif" href=" """
...
<h2 id="h2">Fuck Your System</h2> <br><br>
<h3 id="h3">Hacked By """
...
<p class="style14" align="center"> <font color="White" 
size="6px">Thanks : </font><marquee scrollamount="5" 
size="3px" style="border:1px solid White; text-shadow: 
White 0px 1px 1px; background-color: Black;" width="75%" 
direction="left" ><font size="2px" color="Red" 
face="courier">"""

sbi10 = thx

sbi11 = """</font></marquee><br></p><p align="center">
</div>
</div>
