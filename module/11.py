...
sbi1 = """<!-- <[SBI_22] -->
<html> <head> <meta content='Hacked by <[SBI_22] property='og:title'/> <meta content='article' property='og:type'/> <meta content='http://www.ratiss.org/ioport5.htm' property='og:url'/> <title>"""
